spring-boot-angular-2 [![build](https://travis-ci.org/daggerok/spring-boot-angular-2.svg?branch=ng-directives-variables)](https://travis-ci.org/daggerok/spring-boot-angular-2)
=====================
