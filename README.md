spring-boot-angular-2 [![build](https://travis-ci.org/daggerok/spring-boot-angular-2.svg?branch=ng-data-binding)](https://travis-ci.org/daggerok/spring-boot-angular-2)
=====================
