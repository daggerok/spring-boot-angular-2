spring-boot-angular-2 [![build](https://travis-ci.org/daggerok/spring-boot-angular-2.svg?branch=ng-http-rxjs-observable-subscribe)](https://travis-ci.org/daggerok/spring-boot-angular-2)
=====================
